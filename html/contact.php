...
<head>
  ...
  <title>Contact | Justine Fortier</title>
...
<body>
  <div class="container">
    <div class="header">
      <header>
        <div class="logo">
          <img id="logo" src="../resources/logo-justine_fortier.png" alt="Logo Justine Fortier">
        </div>
      </header>
    </div>
    <div class="sidebar">
    ...
    <div class="footer">
      <footer>
        <ul>
          <li id="linkedin"><a href="https://www.linkedin.com/in/justine-fortier/"><svg viewBox="-10 -10 535 535"
          ...
          <li id="github"><a href="https://github.com/justinefortier"><svg xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="-10 -10 460 460"
